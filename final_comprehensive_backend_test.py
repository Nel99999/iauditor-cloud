...
# Configuration
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://ops-control-center.preview.emergentagent.com')
...
test2@company.com,Test User 2,inspector"""
    ...
    def test_gdpr_system(self):
        ...
        response = self.make_request("GET", "/gdpr/data-retention-policy")
        success = response and response.status_code == 200
        ...
        response = self.make_request("GET", "/gdpr/privacy-report")
        success = response and response.status_code == 200
