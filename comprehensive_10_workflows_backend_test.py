...
# Configuration
BACKEND_URL = os.getenv("REACT_APP_BACKEND_URL", "https://rbacmaster-1.preview.emergentagent.com")
...
def test_workflow_3():
    ...
    try:
        ...
        if response.status_code == 201:
            ...
            log_test(workflow, "Step 2: Create subtask 1", True, "Subtask 1 created (200 OK)")
        else:
