  ...
  const quickStats = [
    {
      ...
      color: 'text-blue-600',
      bgColor: 'bg-blue-50',
      change: `${stats?.users?.active_users || 0} active`,
    },
    {
      ...
      bgColor: 'bg-green-50',
      change: `${stats?.inspections?.completed_today || 0} completed today`,
    },
    {
      title: 'Pending Tasks',
      value: stats?.tasks?.todo + stats?.tasks?.in_progress || 0,
      icon: ListTodo,
    ...
    },
    {
      ...
      value: stats?.checklists?.pending_today || 0,
      icon: CheckSquare,
      color: 'text-orange-600',
      bgColor: 'bg-orange-50',
      change: `${stats?.checklists?.completed_today || 0} done`,
    },
  ];
