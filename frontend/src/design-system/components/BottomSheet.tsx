...
const SNAP_POINTS: Record<BottomSheetSnapPoint, string> = {
  peek: '25%',
  half: '50%',
  full: '90%',
};
 ...
 * 
 * @param isOpen - Controls visibility of the bottom sheet
 * @param onClose - Callback when bottom sheet is closed
 * @param snapPoint - Initial height: 'peek' | 'half' | 'full'
 * @param enableSwipe - Enable swipe gestures (default: true)
 * @param showDragHandle - Show drag handle indicator (default: true)
