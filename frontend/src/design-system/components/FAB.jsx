 ...
 * 
 * @param {string} variant - 'simple' | 'speedDial' (default: 'simple')
 * @param {string} position - 'bottom-right' | 'bottom-center' | 'bottom-left' (default: 'bottom-right')
 * @param {React.ReactNode} icon - Icon component for simple FAB or main icon for speed dial
 * @param {string} label - Accessible label for the button
 * @param {function} onClick - Click handler for simple FAB
 * @param {Array} actions - Array of actions for speed dial: [{ icon, label, onClick, color }]
 * @param {string} color - Color variant: 'primary' | 'secondary' | 'success' | 'danger' (default: 'primary')
 * @param {string} size - Size variant: 'default' | 'large' (default: 'default')
